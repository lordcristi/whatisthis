...
local color_picker_2 = ui_new_color_picker('Visuals', 'Effects', '\n scope_lines_color_picker_2', 0, 0, 0, 255)
...
local g_paint = function()
    ...
    renderer_gradient(width/2 - initial_position + 2, height / 2, initial_position - alpha*offset, 1, color_2[1], color_2[2], color_2[3], alpha*color_2[4], color[1], color[2], color[3], alpha*color[4], true)
    renderer_gradient(width/2 + alpha*offset, height / 2, initial_position - alpha*offset, 1, color[1], color[2], color[3], alpha*color[4], color_2[1], color_2[2], color_2[3], alpha*color_2[4], true)

    renderer_gradient(width / 2, height/2 - initial_position + 2, 1, initial_position - alpha*offset, color_2[1], color_2[2], color_2[3], alpha*color_2[4], color[1], color[2], color[3], alpha*color[4], false)
    renderer_gradient(width / 2, height/2 + alpha*offset, 1, initial_position - alpha*offset, color[1], color[2], color[3], alpha*color[4], color_2[1], color_2[2], color_2[3], alpha*color_2[4], false)
